...
const Routes = (shoesDb, shoesFE ) => {
    ...
    const home = async (req, res, next) => {
        ...
        let shoes = []
        await axios.get('https://shoe_api.herokuapp.com/api/shoes')
            .then((response) => {
    ...
    const viewShoe = async (req, res, next) => {
        ...
        .get(`https://shoe_api.herokuapp.com/api/shoe/${id}`)
            ...
            if(password.length < 8){
                ...
                if(emailPattern.test(email)){
                    ...
                    let data = {"name": name, "lastname": lastname, "email": email, "password": password}
                        const response = await fetch("https://shoe_api.herokuapp.com/api/auth/signup", {
                        method: 'POST',
                        mode: 'cors',
                        cache: 'no-cache',
        ...
        if(!email){
            ...
            if(password.length < 8){
                ...
                if(emailPattern.test(email)){
                    ...
                    const response = await fetch("https://shoe_api.herokuapp.com/api/auth/signin", {
                        method: 'POST',
                        mode: 'cors',
                        cache: 'no-cache',
                        credentials: 'same-origin',
    ...
    const postShoeDb = async (req, res) => {
        ...
        let imageAsBase64 = fs.readFileSync(`./public/img/${image}`, 'base64');
            ...
            await fetch("https://shoe_api.herokuapp.com/api/shoes/add-shoe", {
              method: 'POST',
              mode: 'cors',
              cache: 'no-cache',
              credentials: 'same-origin',
    ...
    const search = async (req, res) => {
        ...
        let displayMessage;
        if(brand){
            await axios.get(`https://shoe_api.herokuapp.com/api/shoes/brand/${brand}`)
            .then((response) => {
                if(response?.data?.status === 'success'){
                    shoes = response?.data?.shoes
                }
            ...
            await axios.get(`https://shoe_api.herokuapp.com/api/shoes/size/${size}`)
            .then((response) => {
                if(response?.data?.status === 'success'){
                    shoes = response?.data?.shoes
                }
            ...
            await axios.get(`https://shoe_api.herokuapp.com/api/shoes/brand/${brand}/size/${size}`)
            .then((response) => {
                if(response?.data?.status === 'success'){
                    shoes = response?.data?.shoes
                }
    ...
    const logout = async (req, res) => {
       const response = await fetch("https://shoe_api.herokuapp.com/api/auth/signout", {
            method: 'POST',
            mode: 'cors',
            cache: 'no-cache',
            credentials: 'same-origin',
