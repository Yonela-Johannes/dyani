...
const Routes = (shoesDb, shoesFE ) => {
    ...
    const viewShoe = async (req, res, next) => {
        ...
        .get(`https://shoe-catalogue.herokuapp.com/api/shoe/${id}`)
            ...
            if(password.length < 8){
                ...
                if(emailPattern.test(email)){
                    ...
                    let data = {"name": name, "lastname": lastname, "email": email, "password": password}
                        const response = await fetch("https://shoe-catalogue.herokuapp.com/api/auth/signup", {
                        method: 'POST',
                        mode: 'cors',
                        cache: 'no-cache',
        ...
        if(!email){
            ...
            if(password.length < 8){
                ...
                if(emailPattern.test(email)){
                    ...
                    const response = await fetch("https://shoe-catalogue.herokuapp.com/api/auth/signin", {
                        method: 'POST',
                        mode: 'cors',
                        cache: 'no-cache',
                        credentials: 'same-origin',
